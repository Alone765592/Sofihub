...
async def start(client, message):
    ...
    if len(message.command) == 2 and message.command[1] in ["premium"]:
        buttons = [[
                    InlineKeyboardButton('📲 ꜱᴇɴᴅ ᴘᴀʏᴍᴇɴᴛ ꜱᴄʀᴇᴇɴꜱʜᴏᴛ', user_id=int(6991688781))
                  ],[
    ...
    if data.split("-", 1)[0] == "BATCH":
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            ...
                            [
                                InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/Aniket_Movies_Hub') #Don't change anything without contacting me @LazyDeveloperr
                            ]
                        ]
                    )
                )
        ...
        if is_valid == True:
            btn = [[
                ...
                InlineKeyboardButton("🏃..Bᴀᴄᴋ Tᴏ Gʀᴏᴜᴘ", url="https://t.me/+6pfQy7bu2KU5MGNl")
            ]]
            await message.reply_photo(
    ...
    msg = await client.send_cached_media(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
             ...
             [
              InlineKeyboardButton('📌 ᴊᴏɪɴ ᴜᴘᴅᴀᴛᴇꜱ ᴄʜᴀɴɴᴇʟ 📌', url=f'https://t.me/Aniket_Movies_Hub') #Don't change anything without contacting me https://t.me/Mrkillersss
             ]
            ]
        )
    )
